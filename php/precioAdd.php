...
<head>
    ...
    <link href="precioAddq.css" rel="stylesheet"> 
</head>
<body>
...
<div class="contenedor-principal">
    ...
    <div class="carrito-compras">
        ...
        <span class="text">Ver Carrito</span></a> 
    </div>
  <!-- BUSQUEDA -->
    <div class="busqueda">
        ...
        <form action="regeditpestaña.php" method="POST">
            <div class="col-md-11 offset-md-0 offset-sm-2 offset-1 col-sm-8 col-10 offset-sm-2 offset-1 mb-3">
                <div class="card">
                    ...
                    <div class="d-flex justify-content-center"> <input type="submit" name="btn-comprar"  class="imgRegedits" style="background-image:url('regedit/<?php echo $fila['idRegedit'] ?>.jpg')"> </div> <b class="px-2">
                    ...
                    <form class="obtener" action="precioAdd.php" method="POST">
                        ...
                        <div> <button name="agregar-carrito" type="submit" 
